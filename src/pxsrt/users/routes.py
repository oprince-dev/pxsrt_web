...
from pxsrt.models import User, Upload
from pxsrt.users.forms import RegisterForm, LoginForm, UpdateAccountForm
from pxsrt.images.utils import save_image, crop_thumbnail
...
def account():
    ...
    profpic = url_for('static', filename='img/profpics/' + current_user.profpic)
    return render_template('account.html', title='Account', form=form, profpic=profpic)
